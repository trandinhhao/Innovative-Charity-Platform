...
public interface ChallengeService {
    ChallengeResponse createChallenge(ChallengeCreationRequest request);
    ...
    UserChallengeResponse submitProof(Long challengeId, MultipartFile file);
    UserChallengeResponse getVerificationStatus(Long userChallengeId);
    List<UserChallengeResponse> getUserChallengeHistory();
}
